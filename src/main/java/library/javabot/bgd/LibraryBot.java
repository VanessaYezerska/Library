...
public class LibraryBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {Message message = update.getMessage();
        ...
        sendMessage.setText("Оберіть потрібний варіант:");
        ...
        if (message.getText().equals("/start")) {
            ...
            ReplyKeyboardMarkup keyboardMarkup = getInstituteKeyboard();
            sendMessage.setReplyMarkup(keyboardMarkup);
            sendMessage.setText(text);

        }
        else if (message.getText().equals("Інститут цивільного захисту")) {
        ...
        }else if (message.getText().equals("Інститут психології та соціального захисту")) {
            ...
            sendMessage.setReplyMarkup(newKeyboardMarkup);
        }else if (message.getText().equals("Інститут пожежної та техногенної безпеки")) {
            // Отримано команду "Інститут психології та соціального захисту", змінюємо клавіатуру
            ReplyKeyboardMarkup newKeyboardMarkup = getNewKeyboardForFireAndTechnogenicSafety();
            sendMessage.setReplyMarkup(newKeyboardMarkup);
        }else if (message.getText().equals("Графік бібліотеки ЛДУ БЖД")) {
            String schedule = "Графік роботи бібліотеки ЛДУ БЖД:\n\n";
            schedule += "Читальні зали: Пн - Сб:  9:00 - 19:00\n";
            schedule += "Абономент:  Пн - Сб:  10:00 - 19:00\n";
    ...
    private ReplyKeyboardMarkup getInstituteKeyboard() {
        ReplyKeyboardMarkup replyKeyboardMarkup = new ReplyKeyboardMarkup();
        replyKeyboardMarkup.setSelective(true);
        replyKeyboardMarkup.setResizeKeyboard(true);
        replyKeyboardMarkup.setOneTimeKeyboard(false);
        ...
        KeyboardRow keyboardRow1 = new KeyboardRow();
        keyboardRow1.add("Інститут цивільного захисту");
        keyboardRows.add(keyboardRow1);

        KeyboardRow keyboardRow2 = new KeyboardRow();
        keyboardRow2.add("Інститут психології та соціального захисту");
        keyboardRows.add(keyboardRow2);

        KeyboardRow keyboardRow3 = new KeyboardRow();
        keyboardRow3.add("Інститут пожежної та техногенної безпеки");
        keyboardRows.add(keyboardRow3);

        KeyboardRow keyboardRow4 = new KeyboardRow();
        keyboardRow4.add("Графік бібліотеки ЛДУ БЖД");
        keyboardRows.add(keyboardRow4);
